package org.contractor.service.setup;
...
public class ContractTimerWebApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    private static final String ENV_TARGET = "envTarget";
    private final Logger logger = LoggerFactory.getLogger(ContractTimerWebApplicationContextInitializer.class);

    public ContractTimerWebApplicationContextInitializer() {
        super();
    }
